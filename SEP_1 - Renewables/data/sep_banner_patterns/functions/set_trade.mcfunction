...
data modify entity @s Offers.Recipes[-1].sell set from entity @e[type=item,sort=nearest,limit=1,distance=..1,nbt={Item:{id: "minecraft:filled_map",components:{"minecraft:map_color":9876543}}}] Item
kill @e[type=item,sort=nearest,limit=1,distance=..1,nbt={Item:{id: "minecraft:filled_map",components:{"minecraft:map_color":9876543}}}]